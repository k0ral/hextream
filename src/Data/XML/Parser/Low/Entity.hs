...
newtype EntityDecoder = EntityDecoder { runEntityDecoder :: Text -> Maybe Text }
...
decodePredefinedEntities = EntityDecoder $ \name ->
  Map.lookup name predefinedEntities & maybe empty pure

predefinedEntities :: Map Text Text
predefinedEntities = Map.fromList
  [ ("lt", "<")
  , ("gt", ">")
  , ("amp", "&")
  , ("quot", "\"")
...
decodeHtmlEntities = EntityDecoder $ \name ->
  Map.lookup name htmlEntities & maybe empty pure
